...
class MainMenuState extends State<MainMenu> {
  ...
  static List<MenuOption> options = <MenuOption>[
    MenuOption(label: 'Vehicule', builder: (BuildContext context) => const TrackerListScreen(), icon: const Icon(Icons.directions_car)),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(Locales.get('VehiculeGPSTrackerPFE', context)),
      ),
      body: Center(
